...
public class ApplicationsController {
	...
	@RequestMapping(value="/saveformi", method=RequestMethod.POST)
	public String saveApplication(HttpServletRequest request, Model model,Applications application,RedirectAttributes redirectAttributes) {
		/// Getting Logged in user
				int userid = 0;
				   ...
				   return "redirect:/applicationform/"+application.getId()+"/F_1/1";	
	...
	public ModelAndView editApplicationsById(@PathVariable int id,HttpServletRequest req) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		/// Getting Logged in user
				int userid = 0;
				User userdeail =null;
					Object principal = SecurityContextHolder.getContext().getAuthentication().getPrincipal();
			 ...
			 if( applicationtqrepository.getIdByApplicationId(id)  != 0 ) {
			  ...
			  List<Object[]> attachmentlist = applicationdocumentrepository.getattachmentdetails(id);
			...
			List<MFormSection> getMFormSectiondata= master_form_section_repository.getMFormSectiondata();
			 ...
			 List<Object[]> f1_id= application_sub_repository.get_id_details(id,1);
			 List<Object[]> f2_id= application_sub_repository.get_id_details(id,2);
			 List<Object[]> f3_id= application_sub_repository.get_id_details(id,3);
			 List<Object[]> f4_id= application_sub_repository.get_id_details(id,4);
			 List<Object[]> f5_id= application_sub_repository.get_id_details(id,5);
			 List<Object[]> f6_id= application_sub_repository.get_id_details(id,6);
			 List<Object[]> f7_id= application_sub_repository.get_id_details(id,7);
			 List<Object[]> f8_id= application_sub_repository.get_id_details(id,8);
			 List<Object[]> f9_id= application_sub_repository.get_id_details(id,9);
			 List<Object[]> f10_id= application_sub_repository.get_id_details(id,10);
			 List<Object[]> f11_id= application_sub_repository.get_id_details(id,11);
			 List<Object[]> f12_id= application_sub_repository.get_id_details(id,12);
			 List<Object[]> f13_id= application_sub_repository.get_id_details(id,13);
			 List<Object[]> f14_id= application_sub_repository.get_id_details(id,14);
			 List<Object[]> f15_id= application_sub_repository.get_id_details(id,15);
			 List<Object[]> f16_id= application_sub_repository.get_id_details(id,16);
			 ...
			 if(f12_id!=null && f12_id.size()>0)
			 {model.addObject("f12_id",f12_id.get(0));}
			 else {model.addObject("f12_id",0);}
	...
	@RequestMapping(value = "/saveapplicationformii", method = RequestMethod.POST)
	public String saveApplicationsFormii(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			...
			//Added On 26-02-2020 For TAB RETURNING	
				//return "redirect:/applicationform/"+applicationid;
			   return "redirect:/applicationform/"+applicationid+"/F_1/2";	
	}

	@RequestMapping(value = "/saveapplicationformiitypecompany", method = RequestMethod.POST)
	public String saveApplicationsFormiitypecompany(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
	...
	@RequestMapping(value = "/saveapplicationformiii", method = RequestMethod.POST)
	public String saveApplicationsFormiii(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
		    ...
		    // List<States> State = stateservice.listall();
			 ...
			 // List<TypeLine> typeline = typelineservice.listall();
		      ...
		      int contactidformiii = Integer.parseInt(request.getParameter("contactidformiii"));
				...
				//return "redirect:/applicationform/"+applicationid;
				 return "redirect:/applicationform/"+applicationid+"/F_1/3";	
			
	}
	
	@RequestMapping(value = "/saveapplicationformiv", method = RequestMethod.POST)
	public String saveApplicationsFormiv(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			...
			//Added On 26-02-2020 For TAB RETURNING	
			//return "redirect:/applicationform/"+applicationid;
		   return "redirect:/applicationform/"+applicationid+"/F_1/4";	
			
	}

	@RequestMapping(value = "/saveapplicationformv", method = RequestMethod.POST)
	public String saveApplicationsFormv(HttpServletRequest request,@ModelAttribute(value="application") @Valid Applications application,BindingResult bindingResult,RedirectAttributes redirectAttributes,@RequestParam MultipartFile proposalfile, @RequestParam MultipartFile notificationfile) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			...
			//  List<Districts> District = districtservice.listall();
			  ...
			  String notificationno = request.getParameter("notification_number");
				...
				//Added On 26-02-2020 For TAB RETURNING	
				//return "redirect:/applicationform/"+applicationid;
			   return "redirect:/applicationform/"+applicationid+"/F_1/5";	
				
	}
	
	@RequestMapping(value = "/saveapplicationformvi", method = RequestMethod.POST)
			...
			//  List<Districts> District = districtservice.listall();
			 ...
			 // List <CropSpecies> cropspecieslist = cropspeciesservice.listall();
			  ...
			  String feature = request.getParameter("dus_features"); 
				if(applicationid != 0)
				{
					int success = applicationsrepository.updateApplicationByFormVI(result,othervalue,feature,id);
			 	...
			 	//Added On 26-02-2020 For TAB RETURNING	
				//return "redirect:/applicationform/"+applicationid;
			   return "redirect:/applicationform/"+applicationid+"/F_1/6";	
					
			
	}
	
	@RequestMapping(value = "/saveapplicationformvii", method = RequestMethod.POST)
	public String saveApplicationsFormvii(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			...
			//  List<Districts> District = districtservice.listall();
			  ...
			  int contactid = Integer.parseInt(request.getParameter("contactid"));
				...
				//Added On 26-02-2020 For TAB RETURNING	
				//return "redirect:/applicationform/"+applicationid;
			   return "redirect:/applicationform/"+applicationid+"/F_1/7";	
					
	}
	
	@RequestMapping(value = "/saveapplicationformviii", method = RequestMethod.POST)
	public String saveApplicationsFormviii(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			...
			//  List<Districts> District = districtservice.listall();
			  ...
			  Date date2 = null;
				...
				//Added On 26-02-2020 For TAB RETURNING	
				//return "redirect:/applicationform/"+applicationid;
			   return "redirect:/applicationform/"+applicationid+"/F_1/8";	
				}
	
	@RequestMapping(value = "/saveapplicationformix", method = RequestMethod.POST)
	public String saveApplicationsFormix(HttpServletRequest request,@ModelAttribute(value="application") @Valid Applications application,BindingResult bindingResult,RedirectAttributes redirectAttributes,@RequestParam MultipartFile firstsaleproof, @RequestParam MultipartFile variationtrait) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			...
			if(iscommercialised.equals("yes")) {
				if(applicationid != 0)
				{
						 ...
						 String originalName = null; String filepath2 = null; String originalName2=null;
								...
								int success =applicationsrepository.updateApplicationByFormIX(radio,originalName,filepath,protection,denomination,trademark,filepath2,date1,applicantid,applicanttypeid,id,originalName2);
					...
					int success =applicationsrepository.updateApplicationByFormIX(radio,"","",protection,denomination,trademark,"",date1,applicantid,applicanttypeid,id,"");
					if(success !=0)
					{
				...
				//Added On 26-02-2020 For TAB RETURNING	
				//return "redirect:/applicationform/"+applicationid;
			   return "redirect:/applicationform/"+applicationid+"/F_1/9";	
			
	}
	
	@RequestMapping(value = "/saveapplicationformx", method = RequestMethod.POST)
	public String saveApplicationsFormx(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
		    ...
		    //List<States> State = stateservice.listall();
			 ...
			 // List<Districts> District = districtservice.listall();
			  ...
			  if(request.getParameter("addrecord") != null) {
				  ...
				  if(request.getParameter("is_farmer_variety_required").equals("true")) {  is_farmer_variety_required = true;   }
				  else {  is_farmer_variety_required = false;	}
				  if(applicationid != 0) { 
					     int s = applicationparentallinerepository.updatedapplicationparentaline(applicationid);
						 int app = applicationsrepository.updateApplicationByFormX(commondenomination, graphicalsource,attribution,owner,planning_benefit_sharing,is_farmer_variety_required,isparentalrequired,applicationid); 
						 if(app !=0) { 
							//SAVING DETAILS IN APPLICATION_SUBMISSION TABLE		
						    	if(Integer.parseInt(request.getParameter("f10_id"))==0 || request.getParameter("f10_id") == null)
						    	{
			...
			//Added On 26-02-2020 For TAB RETURNING	
				//return "redirect:/applicationform/"+applicationid;
			   return "redirect:/applicationform/"+applicationid+"/F_1/10";	
	}
	
	
	@RequestMapping(value = "/saveapplicationformxi", method = RequestMethod.POST)
	public String saveApplicationsFormxi(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			...
			//Added On 26-02-2020 For TAB RETURNING	
				//return "redirect:/applicationform/"+applicationid;
			   return "redirect:/applicationform/"+applicationid+"/F_1/11";	
			
	}
	
	@RequestMapping(value = "/saveapplicationformxii", method = RequestMethod.POST)
	public String saveApplicationsFormxii(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			 ...
			 // List<Districts> District = districtservice.listall();
			  ...
			  String expectedperformance = request.getParameter("expected_performance");
				...
				//Added On 26-02-2020 For TAB RETURNING	
				//return "redirect:/applicationform/"+applicationid;
			   return "redirect:/applicationform/"+applicationid+"/F_1/12";	
	           }
	
	
	@RequestMapping(value = "/savedeclaration_first_form", method = RequestMethod.POST)
	public String saveApplicationsForm1_Declare(HttpServletRequest request,@ModelAttribute(value="application") @Valid Applications application,BindingResult bindingResult,RedirectAttributes redirectAttributes) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			...
			//	return "redirect:/applicationform/"+applicationid;
				return "redirect:/applicationform/"+applicationid+"/F_1/Declaration";
	}
	
	@RequestMapping(value = "/updaterow_form1_subform/{id}/{applicationid}", method = RequestMethod.GET)
	public String updateApplicationsForm1_subform(@PathVariable(name = "id") Integer id,@PathVariable(name = "applicationid") Integer applicationid,HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) 
	{
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
	...
	@RequestMapping(value = "/editnaturalcontact/{id}/{contactid}/{form}/{formid}", method = RequestMethod.GET)
	public ModelAndView editApplicationAgentContactId(
	...
	@RequestMapping(value = "/editagentcontact/{id}/{contactid}/{form}/{formid}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/editapplicationnaturalcontact/{id}/{contactid}/{form}/{formid}", method = RequestMethod.GET)
	public ModelAndView editApplicationNaturalContactByApplicationAndContactId(@PathVariable(name = "id") Integer id,@PathVariable(name = "contactid") Integer contactid,HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes,
			@PathVariable(name = "form") String form,@PathVariable(name = "formid") String formid) 
	{
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		/// Getting Logged in user
	...
	@RequestMapping(value = "/editapplicationcontact/{id}/{contactid}/{form}/{formid}", method = RequestMethod.GET)
	public ModelAndView editApplicationContactByApplicationAndContactId(@PathVariable(name = "id") Integer id,@PathVariable(name = "contactid") Integer contactid,HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes,
			@PathVariable(name = "form") String form,@PathVariable(name = "formid") String formid) 
	{
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		/// Getting Logged in user
	...
	@RequestMapping(value = "/editapplicationconvention/{id}/{conventionid}/{form}/{formid}", method = RequestMethod.GET)
	public ModelAndView editApplicationConventionByApplicationAndConventionidId(@PathVariable(name = "id") Integer id,@PathVariable(name = "conventionid") Integer conventionid,HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes,
			@PathVariable(name = "form") String form,@PathVariable(name = "formid") String formid) 
	{
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		// Getting Logged in user
	...
	@RequestMapping(value = "/editapplicationparentalline/{id}/{parentalid}/{form}/{formid}", method = RequestMethod.GET)
	...
	public String saveApplicationsPayment(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes,@RequestParam MultipartFile paymentfile) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			...
			try {
			  ...
			  //	return "redirect:/applicationform/"+applicationid;
				return "redirect:/applicationform/"+applicationid+"/F_1/Payments";	 
	}
	
	
	@RequestMapping(value = "/saveapplicationquestionnair", method = RequestMethod.POST)
	public String saveApplicationsTechnicalQuestionnair(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes,@RequestParam MultipartFile pedigreefile, @RequestParam MultipartFile trialfile,@RequestParam MultipartFile variation_important_trait,@RequestParam MultipartFile withdrawfile) {
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		...
		/// Getting Logged in user
			...
			//	return "redirect:/applicationform/"+applicationid;
			 return "redirect:/applicationform/"+applicationid+"/F_1/Questionaire";  
				
	}
	
	@SuppressWarnings("unlikely-arg-type")
	@RequestMapping(value = "/tocform/{id}/{sno}", method = RequestMethod.GET)
	public ModelAndView getTocForm(@PathVariable int id,@PathVariable String sno) {
		ModelAndView model = new ModelAndView("application/toc-form");
		/// Getting Logged in user
				int userid = 0;
				User userdeail = null;
					Object principal = SecurityContextHolder.getContext().getAuthentication().getPrincipal();
	...
	public String saveTQCharacteristics(HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) {
		...
		/// Getting Logged in user
			 ...
			 + "duscharistics"+duscharistics+""
			 + "remarks = "+remarks+"charisticsid ="
			 + ""+charisticsid+"tqdusgroupid= "+
			 tqdusgroupid+"vtid= "+vtid);
			  if(editmode == 1) {
				...
				return "redirect:/tocform/"+applicationid+"/"+tqserialnumber;
			
	}
	
	@RequestMapping(value = "/deletecharacteristics/{id}/{varietyid}/{sno}", method = RequestMethod.GET)
	public String deleteCharacteristicsByApplicationIdAndTypeLine(@PathVariable(name = "id") Integer id,@PathVariable(name = "varietyid") Integer varietyid,@PathVariable(name = "sno") Integer sno,HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes) 
	{
		ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
	...
	@RequestMapping(value = "/editcharacteristics/{id}/{varietyid}/{sno}", method = RequestMethod.GET)
	...
	@RequestMapping(value="/form1_attachments", method=RequestMethod.POST)
	...
	{   
		...
		{ 
			return "admin/new_extend_edv_english";
		}else 
	    {
			String UPLOAD_FILEPATH = env.getRequiredProperty("static.content.directory");
		 ...
		 for(int i = 0; i < documenttypeid.length; i++) {
		    	 ...
		    	 */
					  if (fileUpload[i].getSize() >=0) 
					{
						...
						{
						String filename[]=request.getParameterValues("file_f1_attach");
		...
		return "redirect:/applicationform/"+appid+"/F_1/Attachments";
	}

	//Adding here For Other Payments ----11-12-2019
	 
	@RequestMapping(value = "/saveduspayment/{applicationid}", method = RequestMethod.POST)
	public String saveDusPayment(@PathVariable(name = "applicationid") Integer applicationid, HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes,@RequestParam MultipartFile paymentfile) {
		//ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			 ...
			 // int category = Integer.parseInt(request.getParameter("payment_category"));
			  ...
			  String amount = request.getParameter("dustestfee");
			  String offline = null;
			  if(request.getParameter("paymentmode").equals("offline"))
			  {
				  offline  = "offline";
			  }
			  else{  offline  = "online"; }
			  
			  System.out.println("Pritning Offline= "+offline);
			...
			//  System.out.println("sqlStartDate:" +sqlStartDate);
			  ...
			  if(applicationid != 0)
								...
								if (!file.exists()) {
								   file.mkdirs();
								    ...
								    try {
								        ...
								        filepath = UPLOAD_FILEPATH+"DUSPAYMENT/"+originalName;
				...
				//  payments.setPayment_category(category);
				  payments.setCreatedbyip(request.getRemoteAddr());
				  payments.setPaymenttype("DusTestFee");
	...
	@RequestMapping(value = "/saveanualrenewal/{applicationid}", method = RequestMethod.POST)
	public String saveanualrenewal(@PathVariable(name = "applicationid") Integer applicationid, HttpServletRequest request,Applications application,RedirectAttributes redirectAttributes,@RequestParam MultipartFile paymentfile) {
		//ModelAndView model = new ModelAndView("admin/new_extend_edv_english");
		Date date = new Date();
		Timestamp ts = new Timestamp(date.getTime());
		/// Getting Logged in user
			...
			//  System.out.println("sqlStartDate:" +sqlStartDate);
			  ...
			  if(applicationid != 0)
				...
				//  payments.setPayment_category(category);
				  payments.setCreatedbyip(request.getRemoteAddr());
				  payments.setPaymenttype(request.getParameter("paymenttype"));
				  payments.setPaymentstatus("paid");
				  Boolean success = applicationpaymentservice.save(payments);
				  if(success) {
					   redirectAttributes.addFlashAttribute("message", "Data Saved Successfully");
	...
	System.out.println("Printing the success as ="+success);
	 if(success !=0) {
		...
		//Umesh Adding here just for pvp no ... on 06-01-2019
	 	...
	 	//return "redirect:/applicationform/"+id;
...
//Addding Here On 25-02-2020
	...
	@SuppressWarnings("unlikely-arg-type")
	@RequestMapping(value = "/applicationform/{id}/{form}/{form_attach}", method = RequestMethod.GET)
	public ModelAndView formwithtabById(@PathVariable int id,HttpServletRequest req
