...
@Entity
@Table(name="viewstatewisereport_v7")
public class ViewStateWiseReport7 {
	...
	private String protection_start;
	private String protection_end;
	
	
	
	public String getProtection_start() {
		return protection_start;
	}
	public void setProtection_start(String protection_start) {
		this.protection_start = protection_start;
	}
	public String getProtection_end() {
		return protection_end;
	}
	public void setProtection_end(String protection_end) {
